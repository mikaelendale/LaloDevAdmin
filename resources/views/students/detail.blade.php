                        ...
                        <table class="table">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><span class="badge badge-soft-success">{{ $course->enrollments->count() }}</span></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $course->created_at ? $course->created_at->format('jS, F Y') : 'Date not available' }}</td>
                                </tr>
                                <tr>
                                    <th scope="row">Close Date</th>
                                    <td>{{ $course->close_date ? $course->close_date->format('jS, F Y') : 'Date not available' }}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="text-center">
                        ...
                        <p class="text-muted mb-0">Since {{ $course->start_date->format('F Y') }}</p>
                    </div>
                    ...
                    <div class="mt-4">
                        <a href="#!" class="btn btn-soft-primary btn-hover w-100 rounded"><i class="mdi mdi-eye"></i> View all</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-9">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <ul class="vstack gap-3">
                        @foreach ($course->instructor_experience as $experience)
                            <li>{{ $experience }}</li>
                        @endforeach
                    </ul>
