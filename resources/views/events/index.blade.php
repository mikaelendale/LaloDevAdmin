                    ...
                    <div class="col-lg-4">
                        <div class="border p-3 rounded mt-4">
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <h5 class="font-size-14 mb-0">{{ $events->title}}</h5>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="text-muted mt-3">
                                        <p>{{ $events->status}}</p>
                                        <h4></h4>
                                        <p class="mb-0">{{ $events->published_at ? $events->published_at->format('M d, Y') : 'N/A'}}</p>
                                ...
                                <div class="col-lg-6 align-self-end">
                                    <div class="float-end mt-3">
                                        <a href="{{ route('events.detail', $events->id) }}" class="btn btn-primary">Detail</a>
                                    </div>
                                </div>
                            </div>
                        </div>
